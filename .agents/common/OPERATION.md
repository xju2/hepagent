...
* When it comes to creating SLURM scripts, always optimize for computing performance and resource usage. Always add `#SBATCH --mail-type=BEGIN,END,FAIL` and ask the user for their email to include in the SLURM script.
