...
The objective is to create an Explorer agent that explore different research directions.
...
The explore agent is at the same level as the scientist agent, and it can be used in the same way, for example by running `hepagent repl --agent explorer`. The explorer agent will have a different set of tools and skills compared to the scientist agent. Those tools and skills will be determined later.
